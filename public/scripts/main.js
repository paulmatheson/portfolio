...
const dayIcon =
  '<ion-icon name="sunny-outline" id="theme-toggle-icon"></ion-icon>';
const nightIcon =
  '<ion-icon name="moon-outline" id="theme-toggle-icon"></ion-icon>';
...
function animateSharedIntro() {
  ...
  gsap
    ...
    .from("nav > a, .theme-toggle-link", { opacity: 0, y: -10, duration: 0.45 })
    .from(
      ".header-nav li, .header-nav, .menu-button",
      {
        opacity: 0,
        y: -8,
        duration: 0.35,
...
function animateHomePage() {
  ...
  revealWhenVisible(
    ".projects h2, #hm-project-cards article, .projects .btn-lg",
    {
      stagger: 0.06,
    },
  );
...
function animateAboutPage() {
  ...
  gsap
    ...
    .from(
      ".about-main img",
      { opacity: 0, scale: 0.98, duration: 0.55 },
      "-=0.35",
    )
    .from(
  ...
  revealWhenVisible(
    ".about-main h4, .about-main ul li, .interests h2, .interests p, .find-me-socials li",
    {
      stagger: 0.04,
    },
  );
...
function animateProjectsPage() {
  ...
  revealWhenVisible(
    "#project-list article, main section:last-of-type h3, main section:last-of-type .social-links li",
    {
      stagger: 0.05,
    },
  );
