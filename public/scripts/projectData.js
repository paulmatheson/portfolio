const projectsArr = [
  {
    ...
    description:
      "A collection of solutions to Frontend Mentor challenges, showcasing clean and responsive UI design with all projects accessible on GitHub and live on Netlify.",
  ...
  },
  {
    title: "Weather app",
    description:
      "A fully functional weather application that interacts with Visual Crossing's Easy Global Weather API.",
  ...
  },
  {
    ...
    description:
      "A markdown compiler built as part of my coursework. React, HTML/CSS(grid) and Javascript.",
  ...
  },
  {
    ...
    description:
      "An app built to search wikipedia. Built as part of my freeCodeCamp coursework.",
